...
public class ReservationController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ReservationDTO> getReservation(@PathVariable final UUID id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Void> updateReservation(@PathVariable final UUID id,
            @RequestBody @Valid final ReservationDTO reservationDTO) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteReservation(@PathVariable final UUID id) {
